...
namespace IranPost.Net.PersianDateTime
{
    ...
    /// </remarks>
    internal sealed class PersianDateConverter
    {
        #region Fields

        static private double Solar = 365.25;
        static private int GYearOff = 226894;

        static private int[,] gdaytable = new int[,]
            {{31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31}, {31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31}};

        static private int[,] jdaytable = new int[,]
            {{31, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, 29}, {31, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, 30}};

        static private string[] weekdays = new string[]
            {"شنبه", "یکشنبه", "دوشنبه", "سه شنبه", "چهارشنبه", "پنجشنبه", "جمعه"};

        static private string[] weekdaysabbr = new string[] {"ش", "ی", "د", "س", "چ", "پ", "ج"};
        ...
        )
        {
            ...
            MathDivRem(GregYear, 4, out Mod4);
            MathDivRem(GregYear, 100, out Mod100);
            MathDivRem(GregYear, 400, out Mod400);
        ...
        internal static int JalaliDays(
            int iJYear,
            int iJMonth,
            int iJDay
        )
        ...
        public static PersianDate ToPersianDate(
            string date
        )
        {
        ...
        static public string ToGregorianDate(
            PersianDate date
        )
        {
        ...
        /// <param name="i"></param>
        /// <returns></returns>
        private static string toDouble(
            int i
        )
        {
            if (i > 9)
