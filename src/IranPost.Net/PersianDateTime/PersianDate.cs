...
namespace IranPost.Net.PersianDateTime
{
    ...
    /// </summary>
    internal sealed class PersianDate :
        IFormattable,
        ICloneable,
        IComparable,
        ...
        IEquatable<PersianDate>
    {
        ...
        {
            get { return PersianDateConverter.DayOfWeek((DateTime) this); }
        }
        ...
        )
        {
            ...
            {
                throw new InvalidPersianDateException("Invalid year in date time.");
            }
        }
        ...
        )
        {
            ...
            {
                throw new InvalidPersianDateException("Invalid month in date time.");
            }
        }
        ...
        )
        {
            if (MonthNo < 6 && DayNo > 31)
                throw new InvalidPersianDateException("Invalid day in date time.");
        ...
        )
        {
            ...
            {
                throw new InvalidPersianDateException("Invalid hour in date time.");
            }
        }
        ...
        )
        {
            ...
            {
                throw new InvalidPersianDateException("Invalid minute in date time.");
            }
        }
        ...
        )
        {
            ...
            {
                throw new InvalidPersianDateException("Invalid second in date time.");
            }
        }
        ...
        )
        {
            ...
            {
                throw new InvalidPersianDateException("Invalid millisecond in date time.");
            }
        }
        ...
        /// <returns></returns>
        public static PersianDate Parse(
            string value,
            bool includesTime
        )
        {
            ...
            if (includesTime)
            {
                if (value.Length > 19)
                {
                    throw new InvalidPersianDateFormatException("Invalid date time length.");
                }
                ...
                if (dt.Length != 2)
                {
                    throw new InvalidPersianDateFormatException("");
                }
                ...
                {
                    throw new InvalidPersianDateFormatException("Invalid time format.");
                }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        private static PersianDate ParseFullDateTime(
            string value
        )
        {
            if (value == string.Empty)
            ...
            if (dt.Length != 3)
                throw new InvalidPersianDateFormatException("Invalid date time format.");
            ...
            if (dateParts.Length != 3)
                throw new InvalidPersianDateFormatException("Invalid date format.");
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        private static PersianDate ParseDateShortTime(
            string value
        )
        {
            if (value == string.Empty)
        ...
        private static PersianDate ParseShortDate(
            string value
        )
        {
            if (value == string.Empty)
        ...
        public static implicit operator PersianDate(
            DateTime dt
        )
        {
            ...
            switch (format)
            {
                case "D":
                    ...
                    return string.Format("{0} {1} {2} {3}",
                        new object[4] {LocalizedWeekDayName, PDateTimeUtil.ToDouble(Day), LocalizedMonthName, Year});
                ...
                case "f":
                    ...
                    return string.Format("{0} {1} {2} {3} {4}:{5}",
                        new object[6]
                        {
                            LocalizedWeekDayName, PDateTimeUtil.ToDouble(Day), LocalizedMonthName, Year,
                            PDateTimeUtil.ToDouble(Hour), PDateTimeUtil.ToDouble(Minute)
                        });
                ...
                case "F":
                    ...
                    return string.Format("{0} {1} {2} {3} {4}:{5}:{6} {7}",
                        ...
                        {
                            LocalizedWeekDayName, PDateTimeUtil.ToDouble(Day), LocalizedMonthName, Year,
                            PDateTimeUtil.ToDouble(smallhour), PDateTimeUtil.ToDouble(Minute),
                            PDateTimeUtil.ToDouble(Second), designator
                        });
                ...
                case "g":
                    ...
                    return string.Format("{0}/{1}/{2} {3}:{4} {5}",
                        new object[6]
                        {
                            Year, PDateTimeUtil.ToDouble(Month), PDateTimeUtil.ToDouble(Day),
                            PDateTimeUtil.ToDouble(smallhour), PDateTimeUtil.ToDouble(Minute), designator
                        });
                ...
                case "s":
                    //'yyyy-mm-ddThh:mm:ss'
                    return string.Format("{0}-{1}-{2}T{3}:{4}:{5}", Year, PDateTimeUtil.ToDouble(Month),
                        PDateTimeUtil.ToDouble(Day), PDateTimeUtil.ToDouble(Hour), PDateTimeUtil.ToDouble(Minute),
                        PDateTimeUtil.ToDouble(Second));

                case "t":
                    //'hh:mm tt'
                    return string.Format("{0}:{1} {2}", PDateTimeUtil.ToDouble(smallhour),
                        PDateTimeUtil.ToDouble(Minute), designator);
                ...
                default:
                    ...
                    return string.Format("{0}/{1}/{2}", Year, PDateTimeUtil.ToDouble(Month),
                        PDateTimeUtil.ToDouble(Day));
            }
        }
